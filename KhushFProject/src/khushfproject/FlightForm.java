...
public class FlightForm extends javax.swing.JInternalFrame 
{
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel16, javax.swing.GroupLayout.DEFAULT_SIZE, 732, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        NavForm.jdpDesktop.remove(LoginForm.ff);
        NavForm.jdpDesktop.add(LoginForm.sf);
    ...
    private void formInternalFrameClosing(javax.swing.event.InternalFrameEvent evt) {                                          
        NavForm.jdpDesktop.remove(this);
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            CheckoutForm cof=new CheckoutForm(noa,noc,dptTime,vmeal,nmeal,fname1,lname1,age1,gend1,fname2,lname2,age2,gend2,fname3,lname3,age3,gend3,fname4,lname4,age4,gend4,fname5,lname5,age5,gend5,fname6,lname6,age6,gend6,dispDate,flno,frm,to,cls,chrg);
            NavForm.jdpDesktop.remove(LoginForm.ff);
            NavForm.jdpDesktop.add(cof);
            cof.setVisible(true);
            this.setVisible(false);
        }
